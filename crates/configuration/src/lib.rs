...
/// 配置中心存储
pub struct ConfiguratorStore<'a, T, U>
    where
        T: Storage,
        U: Connection {
    connection: &'a U,
...
impl<'a, T, U> Store for ConfiguratorStore<'a, T, U>
    where
        T: Storage,
        U: Connection {
...
impl<'a, T, U> ConfiguratorStore<'a, T, U>
    where
        T: Storage,
        U: Connection {
    /// 创建配置中心存储
...
impl<'a, T, U> Connection for ConfiguratorStore<'a, T, U>
    where
        T: Storage,
        U: Connection {
    fn send(&self) {
